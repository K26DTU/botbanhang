...
# ENV CONFIG
# =========================
APP_VERSION = "2026-08-06-v3-threaded-webhook"
...
def telegram_webhook():
    try:
        ...
        # TeleBot owns a 4-thread handler pool. process_new_updates queues the
        # update and returns quickly, so Telegram does not retry or let callback
        # queries expire while Google Sheets/payOS work is running.
